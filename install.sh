...
up() {
cd $HOME && rm -rf .telegram-cli && rm -rf SinChi && rm -rf sinchi && sudo apt-get update && sudo apt-get upgrade -y && sudo apt-get autoremove && sudo apt-get autoclean && git clone https://github.com/tgMember/sinchi.git && cd sinchi && chmod 777 install.sh && ./install.sh conf && ./install.sh
}
